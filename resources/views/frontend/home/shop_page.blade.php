...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
 ...
 <p>Ada <strong class="text-brand">{{ count($products) }}</strong> Ditemukan!!</p>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6 mb-30">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ url('product/details/'.$product->product_id.'/'.$product->product_slug) }}">
                                            <img class="default-img" src="{{ asset('upload/product/' . $product->image1) }}" alt="{{ $product->name }}">
                                        </a>
                                    </div>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('product/details/'.$product->product_id.'/'.$product->product_slug) }}">{{ $product->name }}</a></h2>
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        @endif
                                        <div class="add-cart">
                                            <a class="add" href="{{ url('product/details/'.$product->product_id.'/'.$product->product_slug) }}">
   ...
   <div class="sidebar-widget price_range range mb-30">
    ...
    <form method="post" action="{{ route('shop.filter') }}">
      ...
      <input type="text" id="amount" value="Rp0 - Rp1.000.000" readonly="">
...
@endphp
    ...
    <div class="custome-checkbox">
        <input class="form-check-input" type="checkbox" name="category[]" id="exampleCheckbox{{ $category->category_id }}" value="{{ $category->category_slug }}" @if(!empty($filterCat) && in_array($category->category_slug,$filterCat)) checked @endif  onchange="this.form.submit()" />
        <label class="form-check-label" for="exampleCheckbox{{ $category->category_id }}"><span>{{ $category->name }} ({{ count($products) }})</span></label>
...
@endforeach
        ...
        <div class="single-post clearfix">
            ...
            <div class="content pt-10">
                <p><a href="{{ url('product/details/'.$product->product_id.'/'.$product->product_slug) }}">{{ $product->name }}</a></p>
