...
@else 
	...
	<div class="container mt-5">
		...
		<a href="{{ url('product/details/'.$item->product_id.'/'.$item->product_slug) }}">
			<div class="list border-bottom">
				<img src="{{ (!empty($product->image3)) ? url('upload/product/'.$product->image3) : url('upload/no_image.jpg') }}" style="width:40px; height:40px">
