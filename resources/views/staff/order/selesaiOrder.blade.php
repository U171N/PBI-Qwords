...
@section('staff')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Data Pesanan Diterima</div>
            <div class="ps-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex order-actions">
                                                <a href="javascript:;" class="update-order-status" data-order-id="{{ $order->order_id }}"><i class="bx bx-cog"></i></a>
                                                <a href="" class="ms-4">
